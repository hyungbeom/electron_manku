...
// code_challenge 생성 함수
    ...
    const handleLogin = async () => {
        ...
        const scopes = ["User.Read", "offline_access", "Files.Read", "Files.ReadWrite","Tasks.ReadWrite","Calendars.ReadWrite", "Contacts.Read", "People.Read","Sites.ReadWrite.All", "Mail.ReadWrite",'MailboxSettings.ReadWrite','Subscription.Read.All'];
    ...
    return <div style={{textAlign: 'center', cursor: 'pointer', width : '100%', backgroundColor : '#2f2f2f', borderRadius : 5, border : '1px solid white'}} onClick={handleLogin}>
