...
import {ExclamationCircleOutlined, RadiusSettingOutlined, SaveOutlined} from "@ant-design/icons";
...
import {DRInfo, orderInfo, sourceInfo} from "@/utils/column/ProjectInfo";
import Table from "@/component/util/Table";
import Popconfirm from "antd/lib/popconfirm";
import Button from "antd/lib/button";

function SourceWriteTest({copyPageInfo, getPropertyId}: any) {
...
export default memo(SourceWriteTest, (prevProps, nextProps) => {
