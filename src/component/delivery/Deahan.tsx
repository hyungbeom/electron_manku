...
export default function Deahan({info, setInfo}){
    ...
    return <>
        ...
        <TopBoxCard title={'기본 정보'} grid={'1fr 1fr 0.6fr 1fr 1fr 1fr'}>
            ...
            {inputForm({title: '고객주문번호', id: 'customerOrderNo'})}
            {inputForm({title: '운송장번호', id: 'trackingNumber'})}
        </TopBoxCard>
        ...
        <div style={{
            ...
            <BoxCard title={'받는분 정보'}>
                ...
                {inputForm({title: '기타연락처', id: 'recipientAltPhone', placeholder: '매입처 당담자 입력 필요'})}
                {inputForm({title: '우편번호', id: 'recipientPostalCode', placeholder: '매입처 당담자 입력 필요'})}
