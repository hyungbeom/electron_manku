                    ...
                    {mini ? <div>
                            <Card size={'small'} style={{
                                ...
                                <div style={{
                                    ...
                                    <div>
                                        <div style={{paddingTop: 8, width: '100%'}}>마감일</div>
                                        <DatePicker value={info['writtenDate']} style={{width: '100%'}}
                                                    onChange={(date, dateString) => onChange({
                                                        target: {
                                                            id: 'writtenDate',
                        ...
                        <div style={{display: 'grid', gridTemplateColumns: '1fr 1.2fr 1.22fr', columnGap: 10}}>
                        ...
                        <Card size={'small'} style={{
                            ...
                            <Card size={'small'}
                                ...
                                <div style={{paddingTop: 8}}>
                                    ...
                                    <TextArea style={{height: '50px'}} id={'remarks'} value={info['remarks']}
                            ...
                            <Card size={'small'} style={{
                                ...
                                <div style={{paddingTop: 8}}>
                                    <div style={{paddingBottom: 3}}>비고란(매입처 관련정보?)</div>
                                    <TextArea style={{height: '150px'}} id={'remarks'} value={info['remarks']}
                                              onChange={onChange} size={'small'}/>
                                </div>
